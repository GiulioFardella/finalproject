...
const animals = [
  {
    ...
    description:
      "Uno dei felini più maestosi, simbolo di potenza e bellezza, ma in grave pericolo di estinzione.",
  },
  {
    id: 2,
    ...
    description:
      "Uno dei mammiferi più rari al mondo, con meno di 100 esemplari rimasti in natura.",
  },
  {
    id: 3,
    ...
    description:
      "Un piccolo coccodrillo d'acqua dolce, minacciato dalla distruzione del suo habitat e dalla caccia.",
  },
  {
    id: 4,
    ...
    description:
      "Un'elegante specie di fenicottero che vive nelle lagune d'alta quota del Sud America.",
  },
  {
    id: 5,
    ...
    description:
      "Una delle più grandi razze d'acqua dolce al mondo, capace di raggiungere grandi dimensioni ",
  },
  {
    id: 6,
    ...
    description:
      "Un primate intelligente e sociale, minacciato dalla deforestazione e dal bracconaggio.",
  },
  {
    id: 7,
    ...
    description:
      "Un anfibio unico con straordinarie capacità rigenerative, gravemente minacciato dall'inquinamento.",
  },
  {
    id: 8,
    ...
    description:
      "Una splendida farfalla alpina vulnerabile ai cambiamenti climatici e alla distruzione del suo habitat.",
  },
  {
    id: 9,
    name: "Murena Gigante",
    ...
    description:
      "Un predatore marino dal morso potente e dalla pelle liscia, spesso nascosto tra le rocce.",
  },
  {
    id: 10,
    ...
    description:
      "Un pinguino sudamericano minacciato dai cambiamenti climatici e dall'inquinamento marino.",
  },
  {
    id: 11,
    ...
    description:
      "Un predatore marino fondamentale per l'ecosistema, noto per la sua caratteristica testa a martello.",
  },
  {
    id: 12,
    ...
    description:
      "Uno dei felini più rari del pianeta, con meno di 100 esemplari in natura.",
  },
  {
    id: 13,
    ...
    description:
      "Il più grande uccello del Nord America, salvato dall'estinzione grazie a programmi di conservazione.",
  },
  {
    id: 14,
    ...
    description:
      "Una delle specie di oranghi più rare e a rischio, scoperta solo di recente.",
  },
  {
    id: 15,
    ...
    description:
      "Una delle tartarughe più rare al mondo, endemica del Madagascar e minacciata dalla caccia illegale.",
  },
  {
    id: 16,
    ...
    description:
      "Un piccolo serpente velenoso, il più minacciato d'Europa a causa della perdita del suo habitat.",
  },
];
