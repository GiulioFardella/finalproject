...
function Cosafacciamo() {
  return (
    <div className="cosafacciamobody p-5">
      <Container>
        <h1 className="text-center mb-4">Le Missioni di Volontariato di ZooVersee</h1>
        ...
        <h2 className="mt-5">Isola di Palawan, Filippine</h2>
        <p className="mb-4">
        ...
        <h2 className="mt-5">Deserto del Rub' al Khali, Emirati Arabi Uniti</h2>
        <p className="mb-4">
        ...
        <h2 className="mt-5">Melbourne, Australia</h2>
        <p className="mb-4">
        ...
        <h2 className="mt-5">Montagne del Ruanda</h2>
        <p className="mb-4">
        ...
        <h2 className="mt-5">Savana del Serengeti</h2>
        <p className="mb-4">
