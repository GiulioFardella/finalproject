...
<div className="form-section">
          ...
          <Col md={6}>
            <Card className="shadow">
              <Card.Body>
                ...
                <p>
                  Il tuo aiuto può salvare animali in pericolo come la gazzella
                  araba, il gatto delle sabbie e la vipera delle sabbie.
                </p>
  ...
  <h3>🌍 Missione di Volontariato: Protezione delle Specie del Deserto 🏜️</h3>
  ...
  <p>
    I volontari saranno ospitati in un <strong>eco-lodge attrezzato nel deserto</strong>, dotato di:
    <ul>
  ...
  <p className="fw-bold">🔗 Unisciti a noi e aiuta a proteggere il futuro del deserto! 🌿🐾</p>
</div>
      </Container>
    </div>
  );
