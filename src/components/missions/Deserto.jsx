    ...
    <div className="deserto-container">
      <Container className="mt-5">
        ...
        <div className="form-section">
              ...
              <Card className="shadow">
                <Card.Body>
                  <h4 className="text-danger">
                    💖 Dona per le Specie del Deserto
                  </h4>
                  <p>
                    Il tuo aiuto può salvare animali in pericolo come la
                    gazzella araba, il gatto delle sabbie e la vipera delle
                    sabbie.
                  </p>
          ...
          <p>
            Nel cuore del <strong>Rub' al Khali</strong>, uno dei deserti più
            vasti e affascinanti del mondo, prende vita un'importante iniziativa
            di conservazione ambientale. In collaborazione con il{" "}
            <strong>governo degli Emirati Arabi Uniti</strong>, questa missione
            di volontariato mira a proteggere le specie in via d'estinzione e
            preservare l'equilibrio dell'ecosistema desertico.
          </p>
          ...
          <p>
            ...
            <ul>
              <li>
                ✔️ <strong>Monitoraggio e tutela</strong> della fauna locale.
              </li>
              <li>
                ✔️ <strong>Ripristino e salvaguardia</strong> delle aree
                naturali danneggiate.
              </li>
              <li>
                ✔️ <strong>Sensibilizzazione delle comunità locali</strong> e
                collaborazione con gli enti di conservazione.
              </li>
            </ul>
          </p>
          ...
          <p>
            I volontari saranno ospitati in un{" "}
            <strong>eco-lodge attrezzato nel deserto</strong>, dotato di:
            <ul>
          ...
          <ul>
            <li>
              🟢 <strong>Giorno 1-2</strong>: Arrivo ad Abu Dhabi, trasferimento
              al campo base, briefing iniziale.
            </li>
            <li>
              🟠 <strong>Giorno 3-7</strong>: Pattugliamento delle aree
              protette, installazione di sensori per monitorare la fauna.
            </li>
            <li>
              🔵 <strong>Giorno 8-10</strong>: Progetti di ripristino ambientale
              e incontri con esperti locali.
            </li>
            <li>
              🟣 <strong>Giorno 11-12</strong>: Attività di sensibilizzazione
              con le comunità locali.
            </li>
            <li>
              🔴 <strong>Giorno 13</strong>: Chiusura della missione, debriefing
              finale e rientro.
            </li>
          </ul>
          ...
          <p>
            Compila il modulo di partecipazione! Dopo aver inviato la tua
            richiesta, riceverai una risposta con tutti i{" "}
            <strong>dettagli specifici della missione</strong>, incluse le{" "}
            <strong>
